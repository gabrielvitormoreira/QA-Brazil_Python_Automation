...
class TestUrbanRoutes:
    ...
    def test_comment_for_driver(self):
        # Adicionar em S8
        print("função criada para o comentário para o motorista0")
        pass

    def test_order_blanket_and_handkerchiefs(self):
        #Adicionar em S8
        print("função criada para solicitar cobertores e lenços")
        pass
    ...
    def test_car_search_model_appears(self):
        #Adicionar em S8
        print("função criada para pesquisar o modelo do carro")